      ...
      <div className="card">
        <div className="flex items-center gap-5">
          ...
          <div className="min-w-0 flex-1">
            ...
            {profile.bio && (
              <p className="mt-3 text-sm text-slate-700 whitespace-pre-line">{profile.bio}</p>
            )}
          </div>
        </div>
        ...
        <div className="mt-6 flex items-center gap-6 border-t border-slate-100 pt-4">
          ...
          <div className="text-center">
            <p className="text-2xl font-bold text-slate-900">{profile.rating_count ?? 0}</p>
        ...
        {((profile.skills_offered?.length > 0) || (profile.skills_wanted?.length > 0)) && (
          <div className="mt-4 grid gap-4 border-t border-slate-100 pt-4 sm:grid-cols-2">
            {profile.skills_offered?.length > 0 && (
              <div>
                <p className="text-xs font-medium text-slate-500 uppercase tracking-wider">Can teach</p>
            ...
            {profile.skills_wanted?.length > 0 && (
              <div>
                <p className="text-xs font-medium text-slate-500 uppercase tracking-wider">Wants to learn</p>
                <div className="mt-2 flex flex-wrap gap-1.5">
